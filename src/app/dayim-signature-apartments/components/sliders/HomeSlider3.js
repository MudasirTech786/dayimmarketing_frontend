...
export default function HomeSlider3() {
    ...
    return (
    <div>
        <div className="flex items-center justify-around bg-white p-10">
            <h3 className="text-4xl text-second font-bold">Lifestyle</h3>
            <div className="flex 
                            md:gap-5">
                <IoIosArrowRoundBack 
                ...
                <IoIosArrowRoundForward 
                    className={`text-6xl cursor-pointer ${myIndex == 7 ? 'text-gray' : 'text-second'}`} 
                    onClick={nextSlide}
                />
            </div>
        </div>
                ...
                <SwiperSlide >
                    <div className="w-[100%] flex flex-col items-center justify-center relative 
                        ...
                        <img 
                            ...
                            alt="" 
                            className="w-[100%] h-[250px] object-cover z-10
                                        lg:w-[700px] lg:h-[500px] md:h-[350px]" 
                        />
