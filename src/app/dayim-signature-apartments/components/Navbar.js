          ...
          <div>
            <div className="flex items-center justify-between  md:block">
              ...
              <Link href="/dayim-signature-apartments">
                <img
                  src="/images/dsa/dsa_logo_golden.png"
                  alt=""
                  className="h-[100px] "
                />
              </Link>
            ...
            >
              <ul className="h-screen md:h-auto items-center justify-center md:flex  pt-2 ">
                <li
                  ...
                  } py-2 md:px-6 text-center border-b-2 md:border-b-0 hover:bg-purple-900  border-purple-900  md:hover:text-purple-600 md:hover:bg-transparent md:text-[10px] lg:text-[15px]`}
                >
                  <Link
                ...
                >
                  <Link
                    href="/dayim-signature-apartments/events"
                    onClick={() => setNavbar(!navbar)}
                  >
                    Events
                  </Link>
                ...
                <li
                  ...
                  } py-2 md:px-6 text-center border-b-2 md:border-b-0  hover:bg-purple-900  border-purple-900  md:hover:text-purple-600 md:hover:bg-transparent md:text-[10px] lg:text-[15px] whitespace-nowrap`}
                >
                  <Link
